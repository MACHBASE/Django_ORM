...
from django.db.backends.base.schema import BaseDatabaseSchemaEditor, _related_non_m2m_objects, _all_related_fields, _is_relevant_relation
...
logger = logging.getLogger('django.db.backends.machbase.schema')
    ...
    def _alter_field(self, model, old_field, new_field, old_type, new_type,
        ...
        if (
            ...
            for fk_name in fk_names:
                ...
                self.execute(self._delete_fk_sql(model, fk_name))
        # foreign_key 기능 지원하지 않음

        # Has unique been removed? / unique를 제공안하는데 실행이 될지 모르겠네
